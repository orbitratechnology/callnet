/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/wrangler.jsonc` (hash: 91f625553fece1430466fd396e5582ea)
// Runtime types generated with workerd@1.20260903.1 2026-09-02 nodejs_compat
interface __BaseEnv_Env {
	FIREBASE_PROJECT_ID: "callnet-orbitra-20260902";
	APNS_BUNDLE_ID: "com.orbitratech.callnet";
	METERED_TURN_CREDENTIALS_URL: "https://orbitratech-turn.metered.live/api/v1/turn/credentials";
	FIREBASE_SERVICE_ACCOUNT_EMAIL: string;
	FIREBASE_SERVICE_ACCOUNT_PRIVATE_KEY: string;
	METERED_TURN_API_KEY: string;
	USER_SESSION: DurableObjectNamespace<import("./workers/src/index").UserSession>;
	CALL_SESSION: DurableObjectNamespace<import("./workers/src/index").CallSession>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/src/index");
		durableNamespaces: "UserSession" | "CallSession";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FIREBASE_PROJECT_ID" | "APNS_BUNDLE_ID" | "METERED_TURN_CREDENTIALS_URL" | "FIREBASE_SERVICE_ACCOUNT_EMAIL" | "FIREBASE_SERVICE_ACCOUNT_PRIVATE_KEY" | "METERED_TURN_API_KEY">> {}
}
